...
const TRANSLATIONS = {
  ...
  en: {
    ...
    /* INDEX — HERO */
    hero_line1:   'Creating powerful web development',
    hero_line2:   'for companies that want to stand out.',
    ...
    /* INDEX — STRIP */
    strip_direct_num:     'Direct to Founder',
    strip_direct_label:   'No Middlemen',
  ...
  nl: {
    ...
    hero_line1:   'Krachtige webontwikkeling creëren',
    hero_line2:   'voor bedrijven die willen opvallen.',
    hero_sub:     'Grote Ideeën. Beginnen met de Juiste Aanpak.',
    hero_cta1:    'Bekijk Ons Werk.',
    hero_cta2:    'Neem Contact Op.',
    hero_scroll:  'Scroll',

    strip_direct_num:     'Direct met de Founder',
    strip_direct_label:   'Geen Tussenpersonen',
  ...
  fr: {
    ...
    hero_line1:   'Créer un développement web puissant',
    hero_line2:   'pour les entreprises qui veulent se démarquer.',
    hero_sub:     'Les Grandes Idées. Commencent par la Bonne Approche.',
    hero_cta1:    'Voir Nos Réalisations.',
    hero_cta2:    'Nous Contacter.',
    hero_scroll:  'Défiler',

    strip_direct_num:     'Direct avec le Fondateur',
    strip_direct_label:   'Sans Intermédiaires',
  ...
  de: {
    ...
    hero_line1:   'Leistungsstarke Webentwicklung erstellen',
    hero_line2:   'für Unternehmen, die auffallen wollen.',
    ...
    strip_direct_num:     'Direkt zum Gründer',
    strip_direct_label:   'Keine Zwischenhändler',
