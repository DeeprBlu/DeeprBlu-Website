...
const TRANSLATIONS = {
  ...
  en: {
    ...
    footer_location:  'Den Bosch, Netherlands',

    /* INDEX — HERO */
    hero_line1:   'Great Ideas',
    hero_line2:   'Start with the Proper Flow.',
    ...
    /* INDEX — STRIP */
    strip_founded_label:  'Projects Delivered',
    ...
    svc_faq_a4:     "Not a problem. I work with clients worldwide. Everything is handled online, so no matter where you are, we can build something great together.",
    ...
    about_p2: "I'm back in the Netherlands, focusing on exactly the kind of businesses that need the most support, wherever in the world they may be based. Small and medium enterprises that have something great to offer the world, but don't yet have a digital presence that matches their ambition.",
    ...
    about_values_label:   'What I stand for.',
    ...
    about_val2_desc:      "I don't do average. Every line of code and every pixel is deliberate.",
    ...
    about_obs_title:       'The gap is everywhere.',
    about_obs_p1:          'Working with local businesses made one thing clear fast: countless SMEs are still running on outdated websites, or have no website at all. In a world where your digital presence is often the first impression you make, that gap is costing them customers every single day.',
    about_obs_p2:          'A well-built website is your digital business card. It helps you grow, keeps you connected to your customers, and tells your story on your terms. Every business deserves that, regardless of size or budget.',
    about_process_label:   'How it works.',
    about_process_1_title: 'Intake.',
    about_process_1_desc:  'We start with a conversation. I learn about your business, your goals, and what you need your website to do for you.',
    about_process_2_title: 'First demo.',
    about_process_2_desc:  'Within days, you get a working demo — a real, clickable version of your site. No mockups, no guesswork. You see exactly what you\'re getting.',
    ...
    contact_loc_val:    'Den Bosch, Netherlands',
    ...
    portfolio_more_desc:  "I'm a young designer building my first wave of projects. Interested in being part of my portfolio?",
  ...
  nl: {
    ...
    footer_copy:      '© Copyright 2026 | DeeprBluMedia',
    footer_location:  'Den Bosch, Nederland',

    hero_line1:   'Grote Ideeën',
    hero_line2:   'Beginnen met de Juiste Aanpak.',
    ...
    strip_founded_label:  'Projecten Opgeleverd',
    ...
    svc_faq_a4:     'Geen probleem. Ik werk met klanten wereldwijd. Alles verloopt online, dus waar u ook bent, bouwen we samen iets moois.',
    ...
    about_p2: 'Inmiddels ben ik weer in Nederland en richt ik mij op precies de bedrijven die de meeste ondersteuning nodig hebben, waar ter wereld ze dan ook wel niet gevestigd zijn. Kleine en middelgrote ondernemingen die iets geweldigs te bieden hebben, maar nog geen digitale aanwezigheid hebben die bij hun ambitie past.',
    ...
    about_values_label:   'Waar ik voor sta.',
    ...
    about_val2_desc:      'Ik doe niet aan gemiddeld. Elke regel code en elke pixel is bewust geplaatst.',
    ...
    about_obs_title:       'Het gat is overal.',
    about_obs_p1:          'Werken met lokale bedrijven maakte één ding duidelijk: talloze kmo\'s draaien nog op verouderde websites, of hebben helemaal geen website. In een wereld waar jouw digitale aanwezigheid vaak de eerste indruk is die je maakt, kost die leemte hen elke dag nieuwe klanten.',
    about_obs_p2:          'Een goed gebouwde website is jouw digitale visitekaartje. Het helpt je groeien, houdt je verbonden met klanten en vertelt jouw verhaal op jouw manier. Elk bedrijf verdient dat, ongeacht grootte of budget.',
    about_process_label:   'Hoe het werkt.',
    about_process_1_title: 'Intake.',
    about_process_1_desc:  'We beginnen met een gesprek. Ik leer jouw bedrijf, jouw doelen en wat jij wilt dat je website voor je doet.',
    about_process_2_title: 'Eerste demo.',
    about_process_2_desc:  'Binnen enkele dagen ontvang je een werkende demo — een echte, klikbare versie van je site. Geen mockups, geen giswerk. Je ziet precies wat je krijgt.',
    ...
    contact_loc_val:    'Den Bosch, Nederland',
  ...
  fr: {
    ...
    footer_copy:      '© Copyright 2026 | DeeprBluMedia',
    footer_location:  'Den Bosch, Pays-Bas',

    hero_line1:   'Les Grandes Idées',
    hero_line2:   'Commencent par la Bonne Approche.',
    ...
    strip_founded_label:  'Projets Livrés',
    ...
    svc_faq_a4:     'Aucun problème. Je travaille avec des clients du monde entier. Tout se passe en ligne, donc où que vous soyez, nous pouvons créer quelque chose de remarquable ensemble.',
    ...
    about_p2: 'Désormais basé aux Pays-Bas, je me concentre sur les entreprises qui ont le plus besoin de soutien. les PME qui ont quelque chose de formidable à offrir mais qui n\'ont pas encore une présence digitale à la hauteur de leurs ambitions.',
    ...
    about_values_label:   'Ce en quoi je crois.',
    ...
    about_val2_desc:      'Je ne fais pas dans la médiocrité. Chaque ligne de code et chaque pixel est délibéré.',
    ...
    about_obs_title:       'Le manque est partout.',
    about_obs_p1:          'Après m\'être installé à Sydney, une chose est devenue vite évidente : d\'innombrables entreprises locales utilisaient encore des sites web dépassés, ou n\'en avaient pas du tout. Dans un monde où votre présence digitale est souvent la première impression que vous donnez, ce manque leur coûte des clients chaque jour.',
    about_obs_p2:          'Un site web bien conçu est votre carte de visite digitale. Il vous aide à grandir, vous maintient en contact avec vos clients et raconte votre histoire selon vos termes. Chaque entreprise mérite cela, quelle que soit sa taille ou son budget.',
    about_process_label:   'Comment ça marche.',
    about_process_1_title: 'Consultation.',
    about_process_1_desc:  'Nous commençons par une conversation. J\'apprends à connaître votre entreprise, vos objectifs et ce que vous attendez de votre site web.',
    about_process_2_title: 'Première démo.',
    about_process_2_desc:  'En quelques jours, vous recevez une démo fonctionnelle — une vraie version cliquable de votre site. Pas de maquettes, pas de suppositions. Vous voyez exactement ce que vous obtenez.',
    ...
    contact_loc_val:    'Den Bosch, Pays-Bas',
  ...
  de: {
    ...
    footer_copy:      '© Copyright 2026 | DeeprBluMedia',
    footer_location:  'Den Bosch, Niederlande',

    hero_line1:   'Große Ideen',
    hero_line2:   'Beginnen mit dem Richtigen Ansatz.',
    ...
    strip_founded_label:  'Projekte Abgeschlossen',
    ...
    about_p2: 'Heute in Sydney, Australien ansässig, konzentriere ich mich auf genau die Unternehmen, die Unterstützung am nötigsten haben. kleine und mittlere Betriebe mit viel Potenzial, aber noch ohne eine digitale Präsenz, die zu ihren Ambitionen passt.',
    ...
    about_values_label:   'Wofür ich stehe.',
    ...
    about_val2_desc:      'Ich mache kein Mittelmaß. Jede Codezeile und jedes Pixel ist bewusst gesetzt.',
    ...
    about_obs_title:       'Sydney zeigte mir die Lücke.',
    about_obs_p1:          'Nach meinem Umzug nach Sydney wurde mir schnell eines klar: Unzählige lokale Unternehmen liefen noch auf veralteten Websites oder hatten gar keine. In einer Welt, in der Ihre digitale Präsenz oft der erste Eindruck ist, den Sie hinterlassen, kostet diese Lücke sie täglich Kunden.',
    about_obs_p2:          'Eine gut gebaute Website ist Ihre digitale Visitenkarte. Sie hilft Ihnen zu wachsen, hält Sie mit Ihren Kunden verbunden und erzählt Ihre Geschichte zu Ihren Bedingungen. Jedes Unternehmen verdient das, unabhängig von Größe oder Budget.',
    about_process_label:   'So funktioniert es.',
    about_process_1_title: 'Erstgespräch.',
    about_process_1_desc:  'Wir beginnen mit einem Gespräch. Ich lerne Ihr Unternehmen, Ihre Ziele und was Ihre Website für Sie leisten soll kennen.',
    about_process_2_title: 'Erste Demo.',
    about_process_2_desc:  'Innerhalb weniger Tage erhalten Sie eine funktionierende Demo — eine echte, klickbare Version Ihrer Website. Keine Mockups, kein Rätselraten. Sie sehen genau, was Sie bekommen.',
    ...
    contact_loc_val:    'Den Bosch, Niederlande',
