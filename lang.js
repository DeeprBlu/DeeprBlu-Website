...
const TRANSLATIONS = {
  ...
  en: {
    ...
    about_p2: "Now based in Sydney, Australia, I focus on exactly the kind of businesses that need the most support. Small and medium enterprises that have something great to offer the world, but don't yet have a digital presence that matches their ambition.",
    ...
    about_obs_title:       'Sydney showed me the gap.',
    about_obs_p1:          'After moving to Sydney, one thing became clear fast: countless local businesses were still running on outdated websites, or had no website at all. In a world where your digital presence is often the first impression you make, that gap is costing them customers every single day.',
    ...
    cs_dan_approach_desc:   "I built a fully custom single-page site that positions the business as professional from the first scroll. Clean layout, strong hierarchy, and a clear path to booking. Services, team, and contact, all in one place, built from scratch.",
    cs_dan_delivery_title:  'The delivery.',
    cs_dan_delivery_desc:   "Concept to live site in under a week. Danilo now has a professional online presence that matches the standard of his work, ready to bring in new customers from day one.",
  ...
  nl: {
    ...
    about_p2: 'Nu gevestigd in Sydney, Australië, richt ik mij op precies de bedrijven die de meeste ondersteuning nodig hebben. kleine en middelgrote ondernemingen die iets geweldigs te bieden hebben, maar nog geen digitale aanwezigheid hebben die bij hun ambitie past.',
    ...
    about_obs_title:       'Sydney liet me het verschil zien.',
    about_obs_p1:          'Na mijn verhuizing naar Sydney viel één ding direct op: talloze lokale bedrijven draaiden nog op verouderde websites, of hadden helemaal geen website. In een wereld waar jouw digitale aanwezigheid vaak de eerste indruk is die je maakt, kost die leemte hen elke dag nieuwe klanten.',
    ...
    cs_dan_label:           'Case Study.',
    cs_dan_title:           "Danilo's Detailing: Een Sydneybedrijf, Nu Live Online.",
  ...
  fr: {
    ...
    svc_faq_a4:     'Aucun problème. Je suis basé à Sydney mais je travaille avec des clients du monde entier. Tout se passe en ligne, donc où que vous soyez, nous pouvons créer quelque chose de remarquable ensemble.',
    ...
    about_p2: 'Désormais basé à Sydney, en Australie, je me concentre sur les entreprises qui ont le plus besoin de soutien. les PME qui ont quelque chose de formidable à offrir mais qui n\'ont pas encore une présence digitale à la hauteur de leurs ambitions.',
    ...
    about_obs_title:       'Sydney m\'a montré le manque.',
    ...
    portfolio_dan_quote:    '"Exactement ce que nous cherchions. Professionnel, épuré et prêt à être mis en ligne."',
  ...
  de: {
    ...
    portfolio_dan_quote:    '"Genau das, was wir gesucht haben. Professionell, sauber und bereit zum Veröffentlichen."',
